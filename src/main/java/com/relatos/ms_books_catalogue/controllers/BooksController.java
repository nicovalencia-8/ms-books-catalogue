...
public class BooksController {
    ...
    public ResponseEntity<GeneralResponse<BookResponse>> books(@PathVariable Integer bookId) {
        try{
    ...
    public ResponseEntity<GeneralResponse<List<BookResponse>>> books(@RequestParam(required = false) String title,
        ...
        try{
            return ResponseEntity.ok(bookService.getAllBooksByFilter(title, authorName, authorLastName, publishedDate, categoryName, isbn, rating, visibility, page, size));
        } catch (IllegalArgumentException ex){
            GeneralResponse<List<BookResponse>> response = new GeneralResponse<>(
                    HttpStatus.BAD_REQUEST.value(),
                    HttpStatus.BAD_REQUEST.getReasonPhrase(),
                    ex.getMessage(),
                    null
    ...
    public ResponseEntity<GeneralResponse<BookResponse>> books(@PathVariable Integer bookId, @RequestBody @Valid CreateBookRequest bookRequest) {
        try{
    ...
    public ResponseEntity<GeneralResponse<BookResponse>> books(@PathVariable Integer bookId, @RequestBody UpdateBookRequest bookRequest) {
        try{
            return ResponseEntity.ok(bookService.updateBookById(bookId, bookRequest));
        } catch (IllegalArgumentException ex){
            GeneralResponse<BookResponse> response = new GeneralResponse<>(
    ...
    public ResponseEntity<GeneralResponse<?>> deleteBooks(@PathVariable Integer bookId) {
        try{
            return ResponseEntity
